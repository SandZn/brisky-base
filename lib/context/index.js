...
exports.createContextGetter = function (key) {
  ...
  if (!value) {
    // need to get rid of this -- but fix it for on data
    key = '_' + key
    // this is pretty wrong im affraid if there is _ it should not do anything
    value = this[key]
    if (value && !value._Constructor && this.hasOwnProperty(key)) {
