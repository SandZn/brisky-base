...
exports.val = function (val, stamp, nocontext) {
  console.log(nocontext, arguments)
  // seems wrong with context here need to pass context trough props as well!
  // (resolvecontext)
  return this.setValue(val, stamp)
}
