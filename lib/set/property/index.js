...
exports.setKey = function (key, val, stamp, resolve, nocontext, params) {
  const prop = this.isProperty(key, val, stamp)
  if (prop) {
    console.log('isProperty', params)
    return this.properties[prop].call(this, val, stamp, resolve, nocontext, prop, params)
  } else {
    console.log('INTERNAL', params)
    return this.setKeyInternal(key, val, stamp, nocontext, this[key], params)
  }
}
