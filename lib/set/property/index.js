...
var cnt = 0
// function is arround 4x faster then the fastest alternative (array)
// may seem dirty but is a huge optmization for v8
...
exports.property = function parseproperty (key, val, stamp, resolve, nocontext) {
  ...
  if (!m) {
    if (cnt > 500) {
      ...
      cnt++
      if (key in this._properties && this._properties[key]) {
        return key
      }
    }
  } else {
