...
exports.propertyTypes = function (properties, property, key, val, stamp, nocontext) {
  ...
  if (prototype && typeof prototype === 'object' && prototype.isBase) {
    clear(this, key, stamp, properties)
    properties[key] = types.base(property, key)
  } else {
    ...
    if (property === null) {
      ...
      properties[key] = types.primitive(property)
    } else if (property === true) {
      properties[key] = types.default
    } else if (isObj(property)) {
      types.custom(this, properties, property, key, stamp)
    } else {
