 ...
 */
 ...
 // original value thats what we want -- origin is not working // giving any usefull information
 // remove origin
 // only user of compute are operators
exports.compute = function (val, previous, start, stamp) {
  if (val === void 0) {
    if (!start) {
  ...
  if (val !== void 0) {
    ...
    if (type === 'function') {
      val = val.call(this, start, stamp, previous)
